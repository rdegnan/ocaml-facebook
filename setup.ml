...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7e8e5636c262077c5b02477b87a1cab8) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "Facebook Graph API client in OCaml";
          description = None;
          categories = [];
            ...
            [
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("uri",
                               Some (OASISVersion.VGreaterEqual "1.3.3"));
                           FindlibPackage
                             ("cohttp.lwt",
                   ...
                   {
                      lib_modules = ["Facebook"; "Facebook_j"; "Facebook_t"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "facebook";
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "Dï\153½\022\127\031\022>¡½Y;*o¤";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
